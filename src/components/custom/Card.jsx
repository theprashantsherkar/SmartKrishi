...
function Card({ title, amount, unit, icon, colors }) {
    ...
    return (
        <>
            <div className='px-7 py-4 border  rounded-md w-max flex flex-col items-center justify-center gap-3 hover:scale-105 hover:shadow-md hover:shadow-slate-300 transition-all hover:cursor-pointer'>
